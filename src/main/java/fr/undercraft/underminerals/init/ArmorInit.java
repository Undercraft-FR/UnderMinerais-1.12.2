...
public class ArmorInit {
    ...
    public static final ItemArmor.ArmorMaterial ARMOR_BLACK_OPALE = EnumHelper.addArmorMaterial("armor_black_opale", Reference.MODID + ":black_opale", 125, new int[] {15, 17, 16, 14}, 18, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 4.5f);
    ...
    public static final Item BLACK_OPALE_HELMET = new ArmorMod("black_opale_helmet", ARMOR_BLACK_OPALE,1, EntityEquipmentSlot.HEAD);
    public static final Item BLACK_OPALE_CHESTPLATE = new ArmorMod("black_opale_chestplate", ARMOR_BLACK_OPALE,1,EntityEquipmentSlot.CHEST);
    public static final Item BLACK_OPALE_LEGGINGS = new ArmorMod("black_opale_leggings", ARMOR_BLACK_OPALE,2,EntityEquipmentSlot.LEGS);
    public static final Item BLACK_OPALE_BOOTS = new ArmorMod("black_opale_boots", ARMOR_BLACK_OPALE,1,EntityEquipmentSlot.FEET);
